...
export default function SotkPublikPage() {
    ...
    <Layout>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        {jabatanSotkList && jabatanSotkList.length > 0 ? (
          <div className="bg-white border border-slate-100 shadow-md rounded-3xl overflow-hidden p-6 relative bg-slate-50/50 max-w-4xl mx-auto w-full">
            <SotkUnifiedChart
